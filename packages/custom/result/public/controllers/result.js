(function () {
  ...
  function ResultController($scope, $window, $log, $location, $q, $filter, Global, Disziplin, Teilnehmer) {
    $scope.global = Global;
    $scope.package = {
      name: 'result'
    };
...
//            console.log(sortedCompetitors);
  ...
  ResultController.$inject = ['$scope', '$window', '$log', '$location', '$q', '$filter', 'Global', 'Disziplin', 'Teilnehmer'];
